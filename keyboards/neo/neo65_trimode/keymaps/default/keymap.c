...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_65_iso_split_bs(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, _______, _______,          KC_HOME,
        ...
        _______, _______, _______, _______,          _______,                   _______, KC_APP,           KC_HOME, KC_PGDN, KC_END
    )
};
